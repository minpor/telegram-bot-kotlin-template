...
class PhotoButtonCommand(
...
) : BotCommand(CommandCode.PHOTO_BUTTON.command, CommandCode.PHOTO_BUTTON.desc) {
    ...
    override fun execute(
        ...
        usersRepository.updateUserStep(chatId, StepCode.PHOTO_BUTTON)

        applicationEventPublisher.publishEvent(
            TelegramStepMessageEvent(chatId = chatId, stepCode = StepCode.PHOTO_BUTTON)
        )
    }
}